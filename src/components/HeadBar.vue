<template>
    <div class="head-bar">
      <router-link class="head-bar-title" :to="{name: 'HomeView'}">豆瓣</router-link>
      <div class="head-bar-content">
        <ul class="head-bar-menu">
          ...
          <li>
            <router-link style="color: #9F7860" :to="{name: 'MovieView'}">图书</router-link>
          </li>
          <li>
            <router-link style="color: #E4A813" :to="{name: 'MovieView'}">广播</router-link>
          </li>
          <li>
